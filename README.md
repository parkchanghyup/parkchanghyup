...
|[물류 운송량 예측 AI 경진대회](https://dacon.io/competitions/official/235867/overview/description)|국토연구원|정형데이터|회귀|
<br/>  
<br/>  
...
|운동 동작 분류 AI 경진대회|광운대학교|분류|정형데이터|
|아파트 실거래가 예측|ibk기업은행|회귀|정형데이터|
|신용카드 사용자 연체 예측|ibk기업은행|분류|정형데이터|
|신용카드 사용자 연체 예측 |한양대erica|분류|정형데이터|
|퇴근시간 버스 승차인원 예측|중앙대|회귀|정형데이터|
